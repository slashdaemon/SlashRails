#!/usr/bin/env python3
"""
Publish SlashRails per-band JARs to Modrinth.
...
Usage:
    ...
    python scripts/publish-modrinth.py --project slashrails --version 0.1.0 --dry-run

    # Publish all bands as a release
    python scripts/publish-modrinth.py --project slashrails --version 0.1.0
